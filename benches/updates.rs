...
fn single_server(c: &mut Criterion) {
    ...
    for num_dels in ALLOSAUR_CHANGES {
        println!("=================================================");
        println!("=Single-server Benchmark with {} deletions=", num_dels);
        println!("=================================================");
...
fn allosaur_update(c: &mut Criterion) {
    ...
    for num_dels in ALLOSAUR_CHANGES {
        println!("=================================================");
        println!(
            "=ALLOSAUR Benchmark with {} deletions and threshold {} =",
            num_dels, THRESHOLD
        );
        println!("=================================================");
        ...
        c.bench_function("ALLOSAUR server-side update ", |b| {
            b.iter(|| servers[0].update(user_d, &user_shares[0]))
        });
