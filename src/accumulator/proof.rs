...
impl MembershipProofCommitting {
    ...
    pub fn get_bytes_for_challenge(&self, transcript: &mut Transcript) {
        transcript.append_message(b"Ec", &self.e_c.to_compressed());
        transcript.append_message(b"T_sigma", &self.t_sigma.to_compressed());
        transcript.append_message(b"T_rho", &self.t_rho.to_compressed());
        transcript.append_message(b"R_E", self.cap_r_e.to_bytes().as_ref());
        transcript.append_message(b"R_sigma", &self.cap_r_sigma.to_compressed());
        transcript.append_message(b"R_rho", &self.cap_r_rho.to_compressed());
        transcript.append_message(b"R_delta_sigma", &self.cap_r_delta_sigma.to_compressed());
        transcript.append_message(b"R_delta_rho", &self.cap_r_delta_rho.to_compressed());
    }
...
impl MembershipProof {
    ...
    pub fn to_bytes(&self) -> [u8; Self::BYTES] {
        ...
        res[0..48].copy_from_slice(&self.e_c.to_compressed());
        res[48..96].copy_from_slice(&self.t_sigma.to_compressed());
        res[96..144].copy_from_slice(&self.t_rho.to_compressed());
        res[144..176].copy_from_slice(&self.s_sigma.to_be_bytes());
        res[176..208].copy_from_slice(&self.s_rho.to_be_bytes());
        res[208..240].copy_from_slice(&self.s_delta_sigma.to_be_bytes());
        res[240..272].copy_from_slice(&self.s_delta_rho.to_be_bytes());
        res[272..304].copy_from_slice(&self.s_y.to_be_bytes());
        res
    }
...
impl NonMembershipProofCommitting {
    /// Create a new non-membership proof committing phase
    pub fn new(
        y: Element,
    ...
    pub fn get_bytes_for_challenge(&self, transcript: &mut Transcript) {
        transcript.append_message(b"Ec", &self.e_c.to_compressed());
        transcript.append_message(b"Ed", &self.e_d.to_compressed());
        transcript.append_message(b"Edm1", &self.e_dm1.to_compressed());
        transcript.append_message(b"T_sigma", &self.t_sigma.to_compressed());
        transcript.append_message(b"T_rho", &self.t_rho.to_compressed());
        transcript.append_message(b"R_E", self.cap_r_e.to_bytes().as_ref());
        transcript.append_message(b"R_A", &self.cap_r_a.to_compressed());
        transcript.append_message(b"R_B", &self.cap_r_b.to_compressed());
        transcript.append_message(b"R_sigma", &self.cap_r_sigma.to_compressed());
        transcript.append_message(b"R_rho", &self.cap_r_rho.to_compressed());
        transcript.append_message(b"R_delta_sigma", &self.cap_r_delta_sigma.to_compressed());
        transcript.append_message(b"R_delta_rho", &self.cap_r_delta_rho.to_compressed());
...
mod tests {
    ...
    fn basic_nonmembership_proof() {
        ...
        let pk = PublicKey::from(&sk);
        let proof_params = ProofParams::new(pk, None);
        let blinding_factor = Some(Element(generate_fr(
            SALT,
